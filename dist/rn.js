...
class Compiler {
    ...
    initProjectFile() {
        ...
        const pkgTempObj = JSON.parse(ejs.render(pkgTmpl, {
  ...
  AppRegistry.registerComponent(appName, () => App);`;
        ...
        Util.printLog("generate" /* GENERATE */, 'package.json', path.join(this.tempPath, 'package.json'));
    }
    ...
    buildBundle() {
        ...
        child_process_1.execSync(`node node_modules/react-native/local-cli/cli.js bundle --entry-file ./index.js --bundle-output ./${BUNDLE_DIR_NAME}/index.bundle --assets-dest ./${BUNDLE_DIR_NAME}`, { stdio: 'inherit' });
    }
...
function startServerInNewWindow({ port = 8081, tempPath }) {
    ...
    const packagerEnvFile = path.join(tempPath, 'node_modules', 'react-native', 'scripts', packagerEnvFilename);
