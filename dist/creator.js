...
class Creator {
    constructor() {
        ...
        this.sourceRoot(path.join(util_1.getRootPath()));
        this.init();
    }
    init() { }
    sourceRoot(rootPath) {
    ...
    template(template, source, dest, data, options) {
        ...
        this.fs.copyTpl(this.templatePath(template, source), this.destinationPath(dest), Object.assign({}, this, data), options);
        return this;
    }
